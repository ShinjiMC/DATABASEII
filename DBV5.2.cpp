...
int main() {
    ...
    while (true) {
        ...
        std::cout << "17. Tener Data de B+ Tree" << std::endl;
        std::cout << "18. Mostrar Datos en Tabla" << std::endl;
        std::cout << "19. Mostrar Datos en Tabla WHERE" << std::endl;
        ...
        if (opcion == 1) {
            ...
            std::cout << "Ingresando a Menu de Arbol" << std::endl;
            PC->ShowDataTree();
        }
        else if (opcion == 18) {
            std::cout << "Selecciono la opcion: Mostrar Datos en Tabla" << std::endl;
            char nombreArchivo[256];
            std::cout << "Ingrese el nombre de la tabla: ";
            std::cin >> nombreArchivo;
            std::cout << std::endl;
            PC->mostrar_data(nombreArchivo,true);
        }
        else if (opcion == 19) {
            std::cout << "Selecciono la opcion: Mostrar Datos en Tabla" << std::endl;
            char nombreArchivo[256];
            ...
            std::cin >> nombreArchivo;
            std::cout << std::endl;
            PC->mostrar_data(nombreArchivo,false);
            }
        else if (opcion == 20) {
...
//892#1#1#"Cumings, Mrs. John Bradley (Florence Briggs Thayer)"#female#38#1#0#PC 17599#71.2833#C85#C
//Movie_Ratings.csv
...
//LONGINT#ID|STR#70#Name|STR#21#Identity|STR#19#Alignment|STR#15#EyeColor|STR#16#HairColor|STR#12#Gender|STR#9#Status|INT#Appearances|STR#18#FirstAppearance|INT#YEAR|STR#7#UNIVERSE|
//15-10-8-4500-4
//99996#Denise Havens (Earth-616)#Secret#Good#Brown#Black#Female##4#éðå-95#1995#DC
